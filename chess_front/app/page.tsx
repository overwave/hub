        ...
        <div className="h-100 d-flex flex-column">
            <header
                ...
                <div className="col-md-3 text-end">
                    <Link href="https://overwave.dev" type="button" className="btn btn-outline-primary me-2">Login</Link>
                ...
                <nav className="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark">
                    <ul className="nav nav-pills flex-column mb-auto">
                        <li className="nav-item">
                            ...
                            <Link href="../chess/play" className="nav-link text-white">
                        ...
                        <hr/>
                        <li className="nav-item">
                            <Link href="../chess/rating" className="nav-link text-white pb-3">
                                <ClipboardData size={24} className="me-3 align-text-bottom"/>
                                <span className="fs-5">Рейтинг</span>
                            </Link>
                        </li>
                        <li>
                            <Link href="../chess/history" className="nav-link text-white pb-3">
                                <ClockHistory size={24} className="me-3 align-text-bottom"/>
                                <span className="fs-5">История</span>
                            </Link>
                        </li>
                        <li>
                            <Link href="../chess/settings" className="nav-link text-white pb-3">
